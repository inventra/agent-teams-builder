...
- GitHub Actions `windows-latest` 與 `macos-latest` 均已通過：兩邊都安裝真實 Codex／Claude Code CLI、驗證 manifest，並執行對應的一鍵安裝器。通過紀錄：<https://github.com/inventra/agent-teams-builder/actions/runs/35630995512>。
